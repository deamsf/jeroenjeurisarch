          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-6 justify-center lg:justify-start">
              <div className="flex items-center space-x-3 group">
                <FiMail className="text-lg text-accent group-hover:scale-110 transition-transform" />
                <a href="mailto:info@jeroenjeuris.be" className="text-sm hover:text-accent transition-colors">
                  info@jeroenjeuris.be
                </a>
              </div>
              <div className="flex items-center space-x-3 group">
                <FiMapPin className="text-lg text-accent group-hover:scale-110 transition-transform" />
                <a
